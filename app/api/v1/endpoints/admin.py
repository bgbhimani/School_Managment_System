...
from app.schemas.Users import UserResponse,TeacherCreate, StudentCreate
from app.schemas.Class import ClassCreate, ClassResponse
...
@admin_router.get('/all_users', response_model=list[UserResponse], status_code=status.HTTP_200_OK)
...
@admin_router.get('/all_classes', response_model=list[ClassResponse], status_code=status.HTTP_200_OK)
...
@admin_router.get('/all_subjects', response_model=list[SubjectResponse], status_code=status.HTTP_200_OK)
